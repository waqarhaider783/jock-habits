    ...
    <div class="twoColumnLayout container">
      <div class="firstColumn container-one">
        <div class="productdetail">
          <product-review-style1 :product="product" />
        </div>
        <div class="ratingBox">
        ...
        <div class="recentBlogs">
          ...
          <div class="blogs">
            <blog-card-style1
              ...
              :border="true"
              url-link="#_"
              title="Nike KD 14 Performance Review"
              date="Septemeber 28, 2020"
        ...
        <div class="couponSection">
          ...
          <div class="coupons">
            <coupon-card-style1
              ...
              sale-text="Sale"
              btn-link="#_"
              title="15% Off Sitewide + Free Shipping on $75+ Authentic Product"
              :use-text="Number(1400)"
              source-url="https://germainmaureau.com/app/uploads/2020/05/Amazon-logo.png"
            />
            <coupon-card-style1
              v-for="index in 2"
              :key="index"
...
// import { GET_ALL_POSTS_TOPICS } from '~/store/types'
export default {
  name: 'ReviewPage',
  ...
  //       console.log('mere ko jaaana parenga ', { newValue, oldValue })
  //     },
  //     deep: true,
  //   },
  // },
